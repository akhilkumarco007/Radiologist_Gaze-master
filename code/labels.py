...
def file_name_changer(dir_path, rad_name):
    '''
    Change the names of the files by adding the name of the radiologist to the previous name in the specified folder.
    :param dir_path: Path for the files
    :param rad_name: name of the radiologist to be added
    :return: None
    '''
...
def label_file_editor(file_path, file_name, min_row, max_row, rad_name):
    '''
    Edit the name column inside the label csv file to add the radiologist name
    :param file_path: path to the csv label file
    :param file_name: name of the csv file
    :param min_row: row number to start the name changing process
    :param max_row: row number to end the name changing process
    :param rad_name: name string of the radiologist
    :return: None
    '''
